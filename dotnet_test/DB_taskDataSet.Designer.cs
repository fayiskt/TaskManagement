...
namespace dotnet_test {
    ...
    public partial class DB_taskDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(string Taskid, string Title, string Description, System.DateTime Duedate, string Status) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow FindByTaskid(string Taskid) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Taskid {
                get {
                    return ((string)(this[this.tableTable.TaskidColumn]));
                }
                set {
            ...
            public System.DateTime Duedate {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableTable.DuedateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Duedate\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.DuedateColumn] = value;
                }
            }
            ...
            public bool IsDuedateNull() {
                return this.IsNull(this.tableTable.DuedateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetDuedateNull() {
                this[this.tableTable.DuedateColumn] = global::System.Convert.DBNull;
            }
...
namespace dotnet_test.DB_taskDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Taskid] = @Original_Taskid) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)) AND ((@IsNull_Duedate = 1 AND [Duedate] IS NULL) OR ([Duedate] = @Original_Duedate)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Taskid], [Title], [Description], [Duedate], [Status])" +
                " VALUES (@Taskid, @Title, @Description, @Duedate, @Status);\r\nSELECT Taskid, Titl" +
                "e, Description, Duedate, Status FROM [Table] WHERE (Taskid = @Taskid)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Taskid] = @Taskid, [Title] = @Title, [Description] = @Description, [Duedate] = @Duedate, [Status] = @Status WHERE (([Taskid] = @Original_Taskid) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)) AND ((@IsNull_Duedate = 1 AND [Duedate] IS NULL) OR ([Duedate] = @Original_Duedate)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));
SELECT Taskid, Title, Description, Duedate, Status FROM [Table] WHERE (Taskid = @Taskid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::dotnet_test.Properties.Settings.Default.DB_taskConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Taskid, Title, Description, Duedate, Status FROM dbo.[Table]";
        ...
        public virtual int Fill(DB_taskDataSet.TableDataTable dataTable) {
        ...
        public virtual DB_taskDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DB_taskDataSet.TableDataTable dataTable = new DB_taskDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DB_taskDataSet.TableDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DB_taskDataSet dataSet) {
        ...
        public virtual int Delete(string Original_Taskid, string Original_Title, string Original_Description, global::System.Nullable<global::System.DateTime> Original_Duedate, string Original_Status) {
        ...
        public virtual int Insert(string Taskid, string Title, string Description, global::System.Nullable<global::System.DateTime> Duedate, string Status) {
            if ((Taskid == null)) {
        ...
        public virtual int Update(string Taskid, string Title, string Description, global::System.Nullable<global::System.DateTime> Duedate, string Status, string Original_Taskid, string Original_Title, string Original_Description, global::System.Nullable<global::System.DateTime> Original_Duedate, string Original_Status) {
            if ((Taskid == null)) {
                throw new global::System.ArgumentNullException("Taskid");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string Description, global::System.Nullable<global::System.DateTime> Duedate, string Status, string Original_Taskid, string Original_Title, string Original_Description, global::System.Nullable<global::System.DateTime> Original_Duedate, string Original_Status) {
            return this.Update(Original_Taskid, Title, Description, Duedate, Status, Original_Taskid, Original_Title, Original_Description, Original_Duedate, Original_Status);
        }
    }
